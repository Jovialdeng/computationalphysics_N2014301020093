# -*- coding: utf-8 -*-
"""
Created on Sun Oct 16 22:01:47 2016
...
A=cannon0(600,45)
A.fly()
sub1.plot(A.X,A.Y,'g-',label='$45\degree$')
A1=cannon0(600,35)
A1.fly()
sub1.plot(A1.X,A1.Y,'g--',label='$35\degree$')
A2=cannon0(600,55)
A2.fly()
sub1.plot(A2.X,A2.Y,'g:',label='$55\degree$') 
...
B=cannon1(600,40)
B.fly()
sub2.plot(B.X,B.Y,'r-',label='$40\degree$')    
B1=cannon1(600,30)
B1.fly()
sub2.plot(B1.X,B1.Y,'r--',label='$30\degree$')
B2=cannon1(600,50)
B2.fly()
sub2.plot(B2.X,B2.Y,'r:',label='$50\degree$') 
...
C=cannon2(600,45)
C.fly()
sub3.plot(C.X,C.Y,'c-',label='$45\degree$')
C1=cannon2(600,35)
C1.fly()
sub3.plot(C1.X,C1.Y,'c--',label='$35\degree$')
C2=cannon2(600,55)
C2.fly()
sub3.plot(C2.X,C2.Y,'c:',label='$55\degree$') 
